...
struct ProfileView: View {
  ...
  private let startTime = Date.now.timeIntervalSince1970
  private let endTime = Date.now.addingTimeInterval(3600).timeIntervalSince1970
  private let userName = "Manas"
  ...
  var body: some View {
    ScrollView {
      VStack {
        ...
        LText("profile").font(AppFont.shantellSans(.regular, size: 16))
        LText("profile").font(AppFont.shantellSans(.italic, size: 16))
        LText("profile").font(AppFont.shantellSans(.light, size: 16))
        LText("profile").font(AppFont.shantellSans(.lightItalic, size: 16))
        LText("profile").font(AppFont.shantellSans(.medium, size: 16))
        LText("profile").font(AppFont.shantellSans(.mediumItalic, size: 16))
        LText("profile").font(AppFont.shantellSans(.bold, size: 16))
        LText("profile").font(AppFont.shantellSans(.boldItalic, size: 16))
        LText("profile").font(AppFont.shantellSans(.semiBold, size: 16))
        LText("profile").font(AppFont.shantellSans(.semiBoldItalic, size: 16))
        LText("profile").font(AppFont.shantellSans(.extraBold, size: 16))
        LText("profile").font(AppFont.shantellSans(.extraBoldItalic, size: 16))
        LText("profile").font(AppFont.corinthia(.regular, size: 20))
        LText("profile").font(AppFont.corinthia(.bold, size: 20))
        ...
        LText("format_num", mixedArgs: [.localizedNumber(num, decimals: decimal)])
